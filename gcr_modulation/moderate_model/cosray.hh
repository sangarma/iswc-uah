...
const double B_0 = 5.0e-05 / unit_magnetic_fluid;
const double u_0 = 4.0e+07 / unit_velocity_fluid;
const double omega = 2.0 * M_PI / (25.0 * 24.0 * 3600.0) / unit_frequency_fluid;
const double kappa_0 = 1.5e21 / unit_diffusion_fluid;
const double eta = 1;
const double f_0 = 1.0;
const double J_0 = 1.0;
const double AU_cgs = 1.496e+13 / unit_length_fluid;
const double r_in = 80.0 * AU_cgs;
const double lambda = 0.1 * AU_cgs;
...
const double T_min = 10.0 * MeV_cgs;
const double T_max = 5000.0 * MeV_cgs;
